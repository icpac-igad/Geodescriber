...
from geodescriber.utils.geo import get_region, human_format, reverse_geocode_a_geostore, check_equivence
...
class GeodescriberService(object):
    ...
    def create_title(title_elements, land_sea):
        ...
        # Create the title based on the truth dictionary
